...
- 数据文件：**106 个 JSON**（含 KET 备考 + PET 镜像 + exam 清单 + V0.6 语法增强 + 语法大厅 12 课）
- 语法大厅：**12/50 课**（基石层 G01-G12 全部完成，共 768 题 + 85 侦探病句；骨架/进阶/精修待 P2-P4）
...
- 勋章：20 个；Service Worker 缓存版本：**ea-v0.9.1**（壳预缓存架构，52 项）
